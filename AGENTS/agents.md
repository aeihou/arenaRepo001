...
| `arenaRepo001.md` | Self-description of this folder, generated by the constructor (incl. the auto-generated **File inventory**) |
...
- **Pseudocode primitives:** `initWorkspace()`, `initSession()`,
  ...
  OR misplaced"))` — POSIX, read-only consistency scan; single-pass cached
  listings),
